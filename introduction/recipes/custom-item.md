...
| **`InventoryFragment_Inspect`**        | "Inspect" action that opens a 3D inspection view of the item.                                                                       | For items the player should be able to examine in 3D.                                                                                                                                | [InventoryFragment_Inspect](../../base-lyra-modified/items/item-fragments-in-depth/inspect-fragment.md)                          |
...
<img src=".gitbook/assets/image (338).png" alt="" title="">
<!-- gb-step:end -->
