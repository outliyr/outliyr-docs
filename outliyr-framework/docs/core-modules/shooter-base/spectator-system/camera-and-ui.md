...
<figure><img src="../../../.gitbook/assets/image (219).png" alt=""><figcaption><p>Spectator quickbar slot widget listening for spectator events</p></figcaption></figure>
...
| **UI**     | Container OnRep\_ → local messages → widgets listen and update                         |
