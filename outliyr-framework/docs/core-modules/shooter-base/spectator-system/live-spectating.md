...
Player presses the corresponding input button; the input action triggers the ability via Input Tag mapping (configured by GameFeatureAction\_AddInputBinding).
{% endstep %}
