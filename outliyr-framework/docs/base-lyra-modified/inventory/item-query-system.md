...
<figure><img src="../../.gitbook/assets/image (233).png" alt=""><figcaption><p>Blueprint graph showing ListenForSpareAmmoChanges event, setting up and using QueryInventoryAsync</p></figcaption></figure>
