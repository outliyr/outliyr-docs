...
*   **Use Case Example:**
    ...
    * When the grip is removed, the ability ends, and the modification is reversed, restoring the original recoil value.
    ...
    <img src=".gitbook/assets/image (16) (1) (1) (1).png" alt="" width="563" title="Subclassed GA_EquipmentAttributeModifier modifying equipment tag attributes">
...
*   **Use Case Example:**
    ...
    * When removed, the rifle's capacity reverts removing any extra ammo in the new reduced `MagazineSize`.
    ...
    <img src=".gitbook/assets/image (18) (1) (1) (1).png" alt="" title=" Subclassed GA_MagazineStatModifier extending magazine by 40">
