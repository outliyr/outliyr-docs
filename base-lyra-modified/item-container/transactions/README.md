...
| [Rollback and Replay](rollback-and-replay.md)       | How later predictions are classified as disjoint or overlapping when an earlier one is rejected or superseded, and the contracts custom ops and containers honour to participate. |
...
<div class="gb-code-title">Example (C++)</div>
