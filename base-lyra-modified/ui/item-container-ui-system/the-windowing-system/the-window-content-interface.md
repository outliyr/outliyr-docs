...
<img src=".gitbook/assets/image (9) (1).png" alt="" title="FItemWindowSpec's SourceDesc">
...
<img src=".gitbook/assets/image (13).png" alt="" title="Example setting the content interface for the equipment widget">

#### `GetFocusableContent` Function

* Return a reference to your main interactive widget (`ListView`, Grid, etc.)

<img src=".gitbook/assets/image (196).png" alt="" width="272" title="Choose equipment slot feet as the default slot">
...
<img src=".gitbook/assets/image (198).png" alt="" title="Pass the center of the last focused equipment slot for better cursor position">
...
<img src=".gitbook/assets/image (200).png" alt="" width="375" title="">

<img src=".gitbook/assets/image (201).png" alt="" title="Example of equipment panel calculating the best slot to focus based on the entry parameters provided">
