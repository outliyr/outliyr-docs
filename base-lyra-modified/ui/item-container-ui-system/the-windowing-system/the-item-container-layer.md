...
<img src=".gitbook/assets/image (7).png" alt="" title="Example binding the wiget classes to window gameplay tags">
...
<img src=".gitbook/assets/image (8).png" alt="" title="Mandatory spawning of the equipment window and inventory grid">
