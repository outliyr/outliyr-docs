...
* The [**Item Query System**](item-query-system/) lets you reactively track specific item types, useful for ammo counters, crafting ingredients, or quest objectives that update as the inventory changes.
