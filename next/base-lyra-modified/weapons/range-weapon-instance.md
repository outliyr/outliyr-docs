...
Your rifle starts accurate, gets wilder as you spray, then recovers when you stop firing. Your shotgun fires 8 pellets in a tight cone. Your sniper deals full damage up close but drops off past 100 meters. `ULyraRangedWeaponInstance` models all of this, it extends [ULyraWeaponInstance](weapon-instance.md) with a dynamic spread/heat system and damage calculation hooks that firing abilities query every shot.
