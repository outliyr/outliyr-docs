...
<img src=".gitbook/assets/image (329).png" alt="" title="">


#### **PlayerScoped Outside**
<img src=".gitbook/assets/image (328).png" alt="" title="">


#### **Bounded LifeCycle**
<img src=".gitbook/assets/image (334).png" alt="" title="Updates the attachment view model when the weapon slot changes">

<img src=".gitbook/assets/image (333).png" alt="" title="Closes the current session to remove free the attachment view model from memory (will still close when the base session closes so no chance of leak)">

<img src=".gitbook/assets/image (331).png" alt="" title="fetches the new attachment viewmodel and creates a new session for the view model">
